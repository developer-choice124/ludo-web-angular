...
@Component({
  ...
  templateUrl: './botanalytics.component.html',
  encapsulation: ViewEncapsulation.None,
  styleUrls: ['./botanalytics.component.scss']
})
export class BotanalyticsComponent implements OnInit, AfterViewInit {
  ...
  openDialog(data_all,data_winner): void {
    const dialogRef = this.dialog.open(BotPlayersOverviewDialog, {
      width: '650px',
  ...
  updateRange(range: Range){
    ...
    this.getroomdetailslist(Parameter2);
  ...
  getroomdetailslist(Parameter2) {
    ...
    forkJoin([
      ...
      this.totalMonthDetailsCount =  result2.data.length;
      var dt2: number = 0;
      var lt2: number = 0;
      Object.keys(result2.data).forEach(key => {
        let value = result2.data[key];
        dt2 += value.coins;
        if(value.max_players==2){
          lt2 += value.coins;
        }
      });
      
      // const newItem = Object.assign({}, result.data, result1.data, result2.data);
      this.dataSource = new MatTableDataSource<RoomData>(result2.data);
      ...
      this.totalMonthDetailsMoneyWon = dt2;
      this.totalMonthDetailsMoneyLost = lt2;
...
@Component({
  ...
  templateUrl: 'botplayers.dialog.component.html',
  encapsulation: ViewEncapsulation.None,
  styleUrls: ['./botanalytics.component.scss']
})

export class BotPlayersOverviewDialog {
  view2:boolean = false;
  view3:boolean = false;
  view4:boolean = false;
  constructor(
    public dialogRef: MatDialogRef<BotPlayersOverviewDialog>,
